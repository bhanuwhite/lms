...
export class CommunityComponent implements OnInit {
  ...
  unAnsweredData = [
    ...
    },
    {
      ...
      message:"No one will answer untill you push them to answer. So be ready for it.",
      name:"Mahesh",
      artName:"needSpaceToAsk"
    },
    {
      head:'Can you ask?',
      message:"If a tutor is busy, One can answer that who knows well. So take a step towards your fear.",
    ...
    },
    {
      ...
      message:" Before joining this course, I can give my self 4 on 10. But now Its 8 on 10. ",
      name:"Sree Olivia",
