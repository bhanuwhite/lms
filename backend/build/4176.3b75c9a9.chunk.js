(self["webpackChunklms"] = self["webpackChunklms"] || []).push([[4176],{
...
// UNUSED EXPORTS: componentsToDebugString, getFullscreenElement, getScreenFrame, hashComponents, isAndroid, isChromium, isDesktopSafari, isEdgeHTML, isGecko, isTrident, isWebKit, load, loadSources, murmurX64Hash128, prepareForSources, sources, transformSource

;// CONCATENATED MODULE: ./node_modules/@fingerprintjs/fingerprintjs/node_modules/tslib/tslib.es6.js
/******************************************************************************
...
var tslib_es6 = __webpack_require__(25719);
...
var tslib_tslib_es6 = __webpack_require__(14874);
...
var lib = __webpack_require__(35258);
...
var Information = __webpack_require__(76853);
...
const w = (0,styled_components_browser_esm/* default */.ZP)(Box/* Box */.x)`
  flex: 1;
  flex-wrap: wrap;
  display: flex;
  flex-direction: row;
`, k = (0,styled_components_browser_esm/* default */.ZP)(Box/* Box */.x)`
  border: 1px solid ${n};
  background: ${s};
  box-shadow: ${({
  theme: o
}) => o.shadows.filterShadow};
`, y = styled_components_browser_esm/* default.button */.ZP.button`
  border: none;
...
`, A = (0,styled_components_browser_esm/* default */.ZP)(Box/* Box */.x)`
  font-size: ${20 / 16}rem;
  svg path {
    fill: ${c};
  }
`, I = ({
  variant: o,
  ...e
}) => o === "success" ? (0,jsx_runtime.jsx)(CheckCircle/* default */.Z, {
  ...e
}) : o === "danger" || o === "warning" ? (0,jsx_runtime.jsx)(ExclamationMarkCircle/* default */.Z, {
  ...e
}) : (0,jsx_runtime.jsx)(Information/* default */.Z, {
  ...e
}), R = (0,styled_components_browser_esm/* default */.ZP)(Box/* Box */.x)`
...
`, L = ({
  ...
  children: (0,jsx_runtime.jsxs)(Flex/* Flex */.k, {
    ...
    children: [(0,jsx_runtime.jsx)(A, {
      ...
      onClick: p,
      "aria-label": c,
      children: (0,jsx_runtime.jsx)(Cross/* default */.Z, {
        "aria-hidden": !0
      })
    })]
  })
...
`, a = ({ children: o }) => /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
  p,
  {
    as: "a",
    href: "#main-content",
...
const s = () => (0,jsx_runtime.jsxs)(VisuallyHidden/* VisuallyHidden */.T, {
  children: [(0,jsx_runtime.jsx)("p", {
    role: "log",
    "aria-live": "polite",
    id: constants/* LiveRegionIds.Log */.V.Log,
    "aria-relevant": "all"
  }), (0,jsx_runtime.jsx)("p", {
    role: "status",
    "aria-live": "polite",
    id: constants/* LiveRegionIds.Status */.V.Status,
    "aria-relevant": "all"
  }), (0,jsx_runtime.jsx)("p", {
    role: "alert",
    "aria-live": "assertive",
    id: constants/* LiveRegionIds.Alert */.V.Alert,
    "aria-relevant": "all"
  })]
});
...
`, c = ({
  children: e,
  theme: t
}) => (0,jsx_runtime.jsxs)(styled_components_browser_esm/* ThemeProvider */.f6, {
  theme: t,
  children: [(0,jsx_runtime.jsx)(ThemeProvider_s, {}), e, (0,jsx_runtime.jsx)(s, {})]
});
...
/* harmony export */ });
/* harmony import */ var _sizes_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(75228);

const i = {
  sizes: _sizes_js__WEBPACK_IMPORTED_MODULE_0__/* .sizes */ .J,
  zIndices: [5, 10, 15, 20],
...
// EXTERNAL MODULE: ./node_modules/@strapi/design-system/dist/themes/common-theme.js
var common_theme = __webpack_require__(30976);
...
const o = (r) => /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("svg", {
  width: "1rem",
  height: "1rem",
  viewBox: "0 0 24 24",
  fill: "none",
...
const i = (l) => /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("svg", {
  width: "1rem",
  height: "1rem",
  viewBox: "0 0 24 24",
  fill: "none",
...
const c = (a) => /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("svg", {
  width: "1rem",
  height: "1rem",
  viewBox: "0 0 24 24",
  fill: "none",
...
const a = (e) => /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("svg", {
  width: "1rem",
  height: "1rem",
  viewBox: "0 0 25 25",
  fill: "none",
