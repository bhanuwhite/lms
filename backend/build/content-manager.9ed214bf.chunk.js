(self["webpackChunklms"] = self["webpackChunklms"] || []).push([[994],{
...
`;
const DragButton = (0,styled_components_browser_esm/* default */.ZP)(ActionBox)`
  padding: 0 ${({ theme }) => theme.spaces[3]};
...
const CardPreview = ({ labelField, transparent, isSibling }) => {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { gap: 3 }, /* @__PURE__ */ react.createElement(DragButton, { alignItems: "center" }, /* @__PURE__ */ react.createElement(Drag/* default */.Z, null)), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { fontWeight: "bold" }, cardEllipsisTitle)),
    /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { paddingLeft: 3 }, /* @__PURE__ */ react.createElement(ActionBox, { alignItems: "center" }, /* @__PURE__ */ react.createElement(Pencil/* default */.Z, null)), /* @__PURE__ */ react.createElement(ActionBox, { alignItems: "center" }, /* @__PURE__ */ react.createElement(Cross/* default */.Z, null)))
  );
};
...
const DragPreviewBox = (0,styled_components_browser_esm/* default */.ZP)(Box/* Box */.x)`
  border: 1px solid ${({ theme }) => theme.colors.neutral200};
`;
const DropdownIconWrapper = (0,styled_components_browser_esm/* default */.ZP)(Box/* Box */.x)`
  height: ${32 / 16}rem;
  width: ${32 / 16}rem;
  border-radius: 50%;
  display: flex;
...
const DragPreview = ({ displayedValue }) => {
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "space-between" }, /* @__PURE__ */ react.createElement(ToggleButton, { type: "button" }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, null, /* @__PURE__ */ react.createElement(DropdownIconWrapper, { background: "neutral200" }, /* @__PURE__ */ react.createElement(CarretDown/* default */.Z, null)), /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { gap: 2, paddingLeft: 6, maxWidth: (0,helper_plugin_esm/* pxToRem */.Q1)(150) }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { textColor: "neutral700", ellipsis: true }, displayedValue)))), /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingLeft: 3 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, null, /* @__PURE__ */ react.createElement(IconButton/* IconButton */.h, { noBorder: true }, /* @__PURE__ */ react.createElement(Trash/* default */.Z, null)), /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingLeft: 2 }, /* @__PURE__ */ react.createElement(IconButton/* IconButton */.h, { noBorder: true }, /* @__PURE__ */ react.createElement(Drag/* default */.Z, null))))))
  );
};
...
const useContentTypeLayout = () => {
  const currentLayout = (0,es/* useSelector */.v9)(selectors);
...
const createMetasSchema = (initialData, models) => {
  const data = utils_mergeMetasWithSchema(cloneDeep_default()(initialData), models, "contentType");
...
const makeSelectModelLinks = () => (0,reselect_es/* createSelector */.P1)(selectAppDomain(), (state) => ({
  collectionTypeLinks: state.collectionTypeLinks,
  singleTypeLinks: state.singleTypeLinks
}));
const makeSelectModelAndComponentSchemas = () => (0,reselect_es/* createSelector */.P1)(selectAppDomain(), ({ components, models }) => ({
...
const LinkEllipsis = (0,styled_components_browser_esm/* default */.ZP)(Link/* Link */.r)`
  display: block;
...
var Select_Option = __webpack_require__(82562);
...
var dist_Link = __webpack_require__(63851);
...
const WysiwygNav = ({
  ...
  if (disabled || isPreviewMode) {
    return /* @__PURE__ */ react.createElement(Box/* Box */.x, { padding: 2, background: "neutral100" }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "space-between" }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, null, /* @__PURE__ */ react.createElement(
      Select/* Select */.P,
      {
        disabled: true,
        id: "selectTitle",
      ...
      /* @__PURE__ */ react.createElement(Select_Option/* Option */.W, { value: "h1" }, "h1"),
      /* @__PURE__ */ react.createElement(Select_Option/* Option */.W, { value: "h2" }, "h2"),
      /* @__PURE__ */ react.createElement(Select_Option/* Option */.W, { value: "h3" }, "h3"),
      /* @__PURE__ */ react.createElement(Select_Option/* Option */.W, { value: "h4" }, "h4"),
      /* @__PURE__ */ react.createElement(Select_Option/* Option */.W, { value: "h5" }, "h5"),
      /* @__PURE__ */ react.createElement(Select_Option/* Option */.W, { value: "h6" }, "h6")
    ), /* @__PURE__ */ react.createElement(MainButtons, null, /* @__PURE__ */ react.createElement(CustomIconButton, { disabled: true, id: "Bold", label: "Bold", name: "Bold", icon: /* @__PURE__ */ react.createElement(Bold/* default */.Z, null) }), /* @__PURE__ */ react.createElement(
      CustomIconButton,
      {
        disabled: true,
        id: "Italic",
  ...
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, { padding: 2, background: "neutral100" }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "space-between" }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, null, /* @__PURE__ */ react.createElement(
  ...
  ), visiblePopover && /* @__PURE__ */ react.createElement(Popover/* Popover */.J2, { centered: true, source: buttonMoreRef, spacing: 4, id: "popover" }, /* @__PURE__ */ react.createElement(FocusTrap/* FocusTrap */.i, { onEscape: handleTogglePopover, restoreFocus: false }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, null, /* @__PURE__ */ react.createElement(IconButtonGroupMargin, null, /* @__PURE__ */ react.createElement(
    CustomIconButton,
    {
    ...
    CustomLinkIconButton,
    {
      ...
      label: "Link",
      name: "Link",
      icon: /* @__PURE__ */ react.createElement(dist_Link/* default */.Z, null)
    }
  ), /* @__PURE__ */ react.createElement(
    CustomIconButton,
    {
...
const InputUID = ({
  ...
  generateUid.current = async (shouldSetInitialValue = false) => {
    ...
    try {
      const {
        data: { data }
      } = await post(utils_getRequestUrl("uid/generate"), {
        contentTypeUID,
        field: name,
        data: modifiedData
      });
  ...
  const checkAvailability = async () => {
    ...
    setIsLoading(true);
    try {
      const { data } = await post(utils_getRequestUrl("uid/check-availability"), {
        contentTypeUID,
        field: name,
...
const CollectionTypeFormWrapper = ({ allLayoutData, children, slug, id, origin }) => {
  ...
  const { formatAPIError } = (0,helper_plugin_esm/* useAPIErrorHandler */.So)(utils_getTrad);
  const isMounted = (0,react.useRef)(true);
  ...
  const handleSubmit = (0,react.useCallback)(
    async (e) => {
      ...
      try {
        ...
        errors = {
          ...errors,
          ...(0,helper_plugin_esm/* getAPIInnerErrors */.nn)(err, { getTrad: utils_getTrad })
        };
      }
      dispatch({
        type: "SET_FORM_ERRORS",
...
const buildQueryString = (queryParams = {}) => {
  ...
  return `${(0,lib.stringify)(otherQueryParams, {
    encode: false,
    addQueryPrefix: true
  })}`;
};
...
const KeyValuePair = ({ label, value }) => {
  return /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "space-between" }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { as: "dt", fontWeight: "bold", textColor: "neutral600" }, label), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { as: "dd" }, value));
};
...
const Information = () => {
  ...
  })), /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingBottom: 4 }, /* @__PURE__ */ react.createElement(Divider/* Divider */.i, null)), /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { direction: "column", alignItems: "stretch", gap: 4 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { direction: "column", alignItems: "stretch", gap: 2, as: "dl" }, /* @__PURE__ */ react.createElement(
    KeyValuePair,
    {
      label: formatMessage({
...
const EditView = ({ allowedActions, isSingleType, goBack, slug, id, origin, userPermissions }) => {
  ...
  return /* @__PURE__ */ react.createElement(DataManagementWrapper, { allLayoutData: layout, slug, id, origin }, ({
    ...
    return /* @__PURE__ */ react.createElement(
      ...
      ), /* @__PURE__ */ react.createElement(Box/* Box */.x, { as: "aside", "aria-labelledby": "links" }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { direction: "column", alignItems: "stretch", gap: 2 }, /* @__PURE__ */ react.createElement(components_InjectionZone, { area: "contentManager.editView.right-links", slug }), slug !== "strapi::administrator" && /* @__PURE__ */ react.createElement(helper_plugin_esm/* CheckPermissions */.jW, { permissions: ctbPermissions }, /* @__PURE__ */ react.createElement(
      ...
      )), /* @__PURE__ */ react.createElement(helper_plugin_esm/* CheckPermissions */.jW, { permissions: configurationPermissions }, /* @__PURE__ */ react.createElement(
        helper_plugin_esm/* LinkButton */.Qj,
        {
          size: "S",
...
`;
const DisplayedFieldButton_DragButton = (0,styled_components_browser_esm/* default */.ZP)(Flex/* Flex */.k)`
  cursor: all-scroll;
  border-right: 1px solid ${({ theme }) => theme.colors.neutral200};
`;
  ...
  switch (type) {
    ...
    case "select": {
      return /* @__PURE__ */ react.createElement(
        ...
        options.map((option) => /* @__PURE__ */ react.createElement(Select_Option/* Option */.W, { key: option, value: option }, option))
      );
    }
    default:
      return null;
...
const ModalForm = ({ onMetaChange, onSizeChange }) => {
  ...
  const sizeField = /* @__PURE__ */ react.createElement(GridItem/* GridItem */.P, { col: 6, key: "size" }, /* @__PURE__ */ react.createElement(
    ...
    FIELD_SIZES.map(([value, label]) => /* @__PURE__ */ react.createElement(Select_Option/* Option */.W, { key: value, value }, label))
  ));
  ...
  const timeStepField = /* @__PURE__ */ react.createElement(GridItem/* GridItem */.P, { col: 6, key: "step" }, /* @__PURE__ */ react.createElement(
    ...
    TIME_FIELD_OPTIONS.map((value) => /* @__PURE__ */ react.createElement(Select_Option/* Option */.W, { key: value, value }, value))
  ));
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Main/* Main */.o, null, /* @__PURE__ */ react.createElement("form", { onSubmit: handleSubmit }, /* @__PURE__ */ react.createElement(
      ...
      /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { direction: "column", alignItems: "stretch", gap: 4 }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "delta", as: "h2" }, formatMessage({
        ...
        entryTitleOptions.map((attribute) => /* @__PURE__ */ react.createElement(Select_Option/* Option */.W, { key: attribute, value: attribute }, attribute))
...
var Loader_Loader = __webpack_require__(88655);
...
const StyledStatus = (0,styled_components_browser_esm/* default */.ZP)(Status/* Status */.q)`
  width: min-content;
`;
const DynamicTable = ({
  canCreate,
    ...
    return [
      ...formattedHeaders,
      {
        ...
        cellFormatter(cellData) {
          ...
          return /* @__PURE__ */ react.createElement(StyledStatus, { showBullet: false, variant, size: "S" }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { fontWeight: "bold", textColor: `${variant}700` }, formatMessage({
...
const FieldPicker = ({ layout }) => {
  ...
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 1, paddingBottom: 1 }, /* @__PURE__ */ react.createElement(
    ...
    allAllowedHeaders.map((header) => {
      return /* @__PURE__ */ react.createElement(Select_Option/* Option */.W, { key: header.name, value: header.name }, formatMessage({
...
function ListView({
  ...
  const pluginsQueryParams = (0,lib.stringify)({ plugins: query.plugins }, { encode: false });
...
const Settings = ({ modifiedData, onChange, sortOptions }) => {
  ...
  return /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { direction: "column", alignItems: "stretch", gap: 4 }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "delta", as: "h2" }, formatMessage({
    ...
    [10, 20, 50, 100].map((pageSize) => /* @__PURE__ */ react.createElement(Select_Option/* Option */.W, { key: pageSize, value: pageSize }, pageSize))
    ...
    sortOptions.map((sortBy) => /* @__PURE__ */ react.createElement(Select_Option/* Option */.W, { key: sortBy, value: sortBy }, metadatas[sortBy].list.label || sortBy))
  )), /* @__PURE__ */ react.createElement(GridItem/* GridItem */.P, { s: 12, col: 3 }, /* @__PURE__ */ react.createElement(
    Select/* Select */.P,
    {
      label: formatMessage({
    ...
    ["ASC", "DESC"].map((order) => /* @__PURE__ */ react.createElement(Select_Option/* Option */.W, { key: order, value: order }, order))
  ))));
};
...
const DraggableCard = ({
  ...
  return /* @__PURE__ */ react.createElement(FieldWrapper, { ref: refs ? refs.dropRef : null }, isDragging && /* @__PURE__ */ react.createElement(components_CardPreview, { transparent: true, labelField: cardEllipsisTitle }), !isDragging && isDraggingSibling && /* @__PURE__ */ react.createElement(components_CardPreview, { isSibling: true, labelField: cardEllipsisTitle }), !isDragging && !isDraggingSibling && /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { gap: 3 }, /* @__PURE__ */ react.createElement(
      ...
      /* @__PURE__ */ react.createElement(Drag/* default */.Z, null)
    ), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { fontWeight: "bold" }, cardEllipsisTitle)),
...
const ListSettingsView = ({ layout, slug }) => {
  ...
  const goBackUrl = () => {
    ...
    const goBackSearch = `${(0,lib.stringify)(
      {
        page: 1,
        pageSize,
        sort
  ...
  const submitMutation = (0,react_query_es.useMutation)((body) => utils_api(body, slug), {
    onSuccess() {
...
const matchByTitle = (links, search) => search ? (0,match_sorter_esm/* default */.Z)(links, search.toLowerCase(), { keys: [(item) => item.title.toLowerCase()] }) : links.sort((link, nextLink) => {
...
const LeftMenu = () => {
  ...
  const { collectionTypeLinks, singleTypeLinks } = (0,es/* useSelector */.v9)(
...
const generateLinks = (links, type, configurations = []) => {
  return links.filter((link) => link.isDisplayed).map((link) => {
    ...
    if (currentContentTypeConfig) {
      ...
      search = (0,lib.stringify)(searchParams, { encode: false });
    }
    return {
      permissions,
      search,
...
const useModels = () => {
  const dispatch = (0,es/* useDispatch */.I0)();
  const toggleNotification = (0,helper_plugin_esm/* useNotification */.lm)();
  const state = (0,es/* useSelector */.v9)(selectAppDomain());
...
const App = () => {
  ...
  return /* @__PURE__ */ react.createElement(Layout/* Layout */.A, { sideNav: /* @__PURE__ */ react.createElement(App_LeftMenu, null) }, /* @__PURE__ */ react.createElement(DragLayer, null), /* @__PURE__ */ react.createElement(contexts_ModelsContext.Provider, { value: { refetchData } }, /* @__PURE__ */ react.createElement(react_router/* Switch */.rs, null, /* @__PURE__ */ react.createElement(react_router/* Route */.AW, { path: "/content-manager/components/:uid/configurations/edit" }, /* @__PURE__ */ react.createElement(helper_plugin_esm/* CheckPagePermissions */.O4, { permissions: App_cmPermissions.componentsConfigurations }, /* @__PURE__ */ react.createElement(ComponentSetttingsView, null))), /* @__PURE__ */ react.createElement(
    react_router/* Route */.AW,
    {
