(self["webpackChunklms"] = self["webpackChunklms"] || []).push([[5895],{
...
const urlToFile = async (url) => {
  try {
    const res = await axios["default"].get(url, { responseType: "blob", timeout: 8e3 });
...
const PendingLogoDialog = ({ onClose, asset, prev, next, goTo, setLocalImage, onChangeLogo }) => {
  ...
  }))), /* @__PURE__ */ react.createElement(Box/* Box */.x, { maxWidth: (0,helper_plugin_esm/* pxToRem */.Q1)(180) }, /* @__PURE__ */ react.createElement(LogoModalStepper_ImageCardAsset, { asset }))), /* @__PURE__ */ react.createElement(
    ModalFooter/* ModalFooter */.m,
    {
      startActions: /* @__PURE__ */ react.createElement(Button/* Button */.z, { onClick: onClose, variant: "tertiary" }, formatMessage({
        id: "Settings.application.customization.modal.cancel",
...
const defaultRoutes = [
  {
    async Component() {
      const component = await Promise.all(/* import() | admin-roles-list */[__webpack_require__.e(233), __webpack_require__.e(3455)]).then(__webpack_require__.bind(__webpack_require__, 98906));
      return component;
    },
    to: "/settings/roles",
    exact: true
  ...
  {
    async Component() {
      const component = await __webpack_require__.e(/* import() | webhook-list-page */ 4121).then(__webpack_require__.bind(__webpack_require__, 11199));
      return component;
    },
...
const p = `${232 / 16}rem`, s = (0,styled_components__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .ZP)(_Grid_Grid_js__WEBPACK_IMPORTED_MODULE_2__/* .Grid */ .r)`
  width: ${p};
  ...
  z-index: 1;
`, l = ({ ariaLabel: r, ...o }) => /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(s, { "aria-label": r, as: "nav", ...o });
l.propTypes = {
...
const d = (0,styled_components_browser_esm/* default */.ZP)(Divider/* Divider */.i)`
  width: ${24 / 16}rem;
...
`, f = ({ as: l, label: u, searchLabel: s, searchable: g, onChange: h, value: b, onClear: E, onSubmit: S, id: y }) => {
  const [o, i] = (0,react.useState)(!1), m = usePrevious_s(o), C = (0,useId/* useId */.M)(y), a = (0,react.useRef)(), c = (0,react.useRef)();
  (0,react.useEffect)(() => {
  ...
  const v = () => {
    ...
    t.key === keyboardKeys/* KeyboardKeys.ESCAPE */.y.ESCAPE && i(!1);
  };
  return o ? /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingLeft: 4, paddingTop: 5, paddingBottom: 2, paddingRight: 4 }, /* @__PURE__ */ react.createElement(SearchForm/* SearchForm */.U, null, /* @__PURE__ */ react.createElement(
    ...
    s
  )), /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingLeft: 2, paddingTop: 4 }, /* @__PURE__ */ react.createElement(d, null))) : /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingLeft: 6, paddingTop: 6, paddingBottom: 2, paddingRight: 4 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "space-between", alignItems: "flex-start" }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "beta", as: l }, u), g && /* @__PURE__ */ react.createElement(IconButton/* IconButton */.h, { ref: c, onClick: v, label: s, icon: /* @__PURE__ */ react.createElement(Search/* default */.Z, null) })), /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 4 }, /* @__PURE__ */ react.createElement(d, null)));
};
f.defaultProps = {
  as: "h2",
  searchable: !1,
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(67294);
/* harmony import */ var _strapi_icons__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(71818);
...
const $ = (0,styled_components__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .ZP)(_Box_Box_js__WEBPACK_IMPORTED_MODULE_2__/* .Box */ .x)`
  display: flex;
  align-items: center;
...
`, s = (0,styled_components__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .ZP)(_strapi_icons__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z)`
  width: ${12 / 16}rem;
  height: ${4 / 16}rem;
  * {
    fill: ${({ theme: e, $active: o }) => o ? e.colors.primary600 : e.colors.neutral600};
  }
`, b = styled_components__WEBPACK_IMPORTED_MODULE_1__/* ["default"].div */ .ZP.div`
  svg {
    height: ${12 / 16}rem;
    width: ${12 / 16}rem;
  }
`, n = react__WEBPACK_IMPORTED_MODULE_0__.forwardRef(({ children: e, icon: o, withBullet: c, as: m, isSubSectionChild: d, ...u }, f) => /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
  ...
  /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_Flex_Flex_js__WEBPACK_IMPORTED_MODULE_5__/* .Flex */ .k, null, o ? /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(b, null, o) : /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(s, null), /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_Box_Box_js__WEBPACK_IMPORTED_MODULE_2__/* .Box */ .x, { paddingLeft: 2 }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_Typography_Typography_js__WEBPACK_IMPORTED_MODULE_3__/* .Typography */ .Z, { as: "span" }, e))),
  c && /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_Box_Box_js__WEBPACK_IMPORTED_MODULE_2__/* .Box */ .x, { as: _Flex_Flex_js__WEBPACK_IMPORTED_MODULE_5__/* .Flex */ .k, paddingRight: 4 }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(s, { $active: !0 }))
));
...
const i = (0,styled_components_browser_esm/* default */.ZP)(Flex/* Flex */.k)`
  border: none;
  padding: 0;
  background: transparent;
`, f = styled_components_browser_esm/* default.div */.ZP.div`
  display: flex;
  align-items: center;
  transform: rotateX(${({ rotated: t }) => t ? "0deg" : "180deg"});
`, SubNavSectionLabel_m = ({ collapsable: t, label: a, onClick: d, ariaExpanded: o, ariaControls: c }) => t ? /* @__PURE__ */ react.createElement(
  i,
  {
    as: "button",
    onClick: d,
  ...
  /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingRight: 1 }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "sigma", textColor: "neutral600" }, a)),
  t && /* @__PURE__ */ react.createElement(f, { rotated: o }, /* @__PURE__ */ react.createElement(CarretDown/* default */.Z, { "aria-hidden": !0 }))
) : /* @__PURE__ */ react.createElement(i, null, /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingRight: 1 }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "sigma", textColor: "neutral600" }, a)));
...
`, p = ({ collapsable: r, label: s, badgeLabel: o, children: d, id: m }) => {
  const [n, c] = (0,react.useState)(!0), a = (0,useId/* useId */.M)(m), u = () => {
    c((i) => !i);
  };
  return /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { direction: "column", alignItems: "stretch", gap: 1 }, /* @__PURE__ */ react.createElement(k, { paddingLeft: 6, paddingTop: 2, paddingBottom: 2, paddingRight: 4 }, /* @__PURE__ */ react.createElement(Box/* Box */.x, { position: "relative", paddingRight: o ? 6 : 0 }, /* @__PURE__ */ react.createElement(
    SubNavSectionLabel_m,
    {
      onClick: u,
      ariaExpanded: n,
      ariaControls: a,
    ...
    o
  ))), (!r || n) && /* @__PURE__ */ react.createElement("ol", { id: a }, react.Children.map(d, (i, g) => /* @__PURE__ */ react.createElement("li", { key: g }, i))));
};
p.defaultProps = {
  badgeLabel: null,
  collapsable: !1,
...
const d = ({ children: t, spacing: o = 2, horizontal: r = !1, ...m }) => /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_Box_Box_js__WEBPACK_IMPORTED_MODULE_1__/* .Box */ .x, { paddingTop: 2, paddingBottom: 4 }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
