(self["webpackChunklms"] = self["webpackChunklms"] || []).push([[8880],{
...
const h = (t) => /* @__PURE__ */ (0,jsx_runtime.jsxs)("svg", {
  width: "1rem",
  height: "1rem",
  viewBox: "0 0 32 24",
  fill: "none",
...
const o = (t) => /* @__PURE__ */ (0,jsx_runtime.jsxs)("svg", {
  width: "1rem",
  height: "1rem",
  viewBox: "0 0 32 24",
  fill: "none",
...
const a = (h) => /* @__PURE__ */ (0,jsx_runtime.jsxs)("svg", {
  width: "1rem",
  height: "1rem",
  viewBox: "0 0 32 24",
  fill: "none",
...
const t = (e) => /* @__PURE__ */ (0,jsx_runtime.jsxs)("svg", {
  width: "1rem",
  height: "1rem",
  viewBox: "0 0 32 24",
  fill: "none",
...
const AttributeIcon = ({ type, customField, ...rest }) => {
  ...
  return /* @__PURE__ */ react.createElement(IconBox, { height: (0,helper_plugin_esm/* pxToRem */.Q1)(24), width: (0,helper_plugin_esm/* pxToRem */.Q1)(32), shrink: 0, ...rest, "aria-hidden": true }, /* @__PURE__ */ react.createElement(Box/* Box */.x, { as: Compo }));
};
...
// EXTERNAL MODULE: ./node_modules/@strapi/design-system/dist/Select/MultiSelectNested.js + 1 modules
var MultiSelectNested = __webpack_require__(17603);
...
const R = (0,styled_components_browser_esm/* default */.ZP)(BaseButton/* BaseButtonWrapper */.G)`
  &[aria-disabled='true'] {
...
`, A = react.forwardRef(({
  ...
  return (0,jsx_runtime.jsxs)(R, {
    ...
    ...g,
    as: a && !r ? react_router_dom/* NavLink */.OL : "a",
    children: [o && (0,jsx_runtime.jsx)(Flex/* Flex */.k, {
      "aria-hidden": !0,
      children: o
      ...
      children: m
    }), i && (0,jsx_runtime.jsx)(Flex/* Flex */.k, {
      "aria-hidden": !0,
      children: i
    })]
  });
...
const EmptyCard = (0,styled_components_browser_esm/* default */.ZP)(Box/* Box */.x)`
...
const CustomFieldsList = () => {
  const { formatMessage } = (0,useIntl/* default */.Z)();
  const customFields = (0,helper_plugin_esm/* useCustomFields */.mZ)();
...
const FormModalHeader = ({
  ...
  return /* @__PURE__ */ react.createElement(ModalHeader/* ModalHeader */.x, null, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { gap: 3 }, /* @__PURE__ */ react.createElement(AttributeIcon/* default */.Z, { type: icon, customField: customFieldUid }), /* @__PURE__ */ react.createElement(Breadcrumbs/* Breadcrumbs */.O, { label: breadcrumbsLabel }, headers.map((header, index) => {
...
const n = (l) => /* @__PURE__ */ (0,jsx_runtime.jsx)("svg", {
  width: "1rem",
  height: "1rem",
  viewBox: "0 0 24 24",
  fill: "none",
...
const o = (l) => /* @__PURE__ */ (0,jsx_runtime.jsxs)("svg", {
  width: "1rem",
  height: "1rem",
  viewBox: "0 0 24 24",
  fill: "none",
...
const OneToMany_n = (e) => /* @__PURE__ */ (0,jsx_runtime.jsxs)("svg", {
  width: "1rem",
  height: "1rem",
  viewBox: "0 0 24 25",
  fill: "none",
...
}), OneToMany_t = OneToMany_n;


;// CONCATENATED MODULE: ./node_modules/@strapi/icons/dist/ManyToOne.js

const ManyToOne_n = (e) => /* @__PURE__ */ (0,jsx_runtime.jsxs)("svg", {
  width: "1rem",
  height: "1rem",
  viewBox: "0 0 24 25",
  fill: "none",
...
}), ManyToOne_t = ManyToOne_n;


;// CONCATENATED MODULE: ./node_modules/@strapi/icons/dist/ManyToMany.js

const Z = (a) => /* @__PURE__ */ (0,jsx_runtime.jsxs)("svg", {
  width: "1rem",
  height: "1rem",
  viewBox: "0 0 24 24",
  fill: "none",
...
const a = (e) => /* @__PURE__ */ (0,jsx_runtime.jsxs)("svg", {
  width: "1rem",
  height: "1rem",
  viewBox: "0 0 24 24",
  fill: "none",
...
const components_Wrapper = (0,styled_components_browser_esm/* default */.ZP)(Box/* Box */.x)`
  position: relative;
  width: 100%;
  &::before {
    content: '';
...
`;
const IconWrapper = (0,styled_components_browser_esm/* default */.ZP)(Box/* Box */.x)`
...
`;
const InfosWrapper = (0,styled_components_browser_esm/* default */.ZP)(Flex/* Flex */.k)`
  position: absolute;
  bottom: 0;
  left: 0;
  right: 0;
...
const relations = {
  oneWay: t,
  oneToOne: i,
  oneToMany: OneToMany_t,
  manyToOne: ManyToOne_t,
  manyToMany: ManyToMany_i,
  manyWay: d
};
...
const createCategorySchema = (usedCategoryNames) => {
  const shape = {
    name: yup_es/* string */.Z_().matches(regex, helper_plugin_esm/* translatedErrors.regex */.I0.regex).test({
      name: "nameNotAllowed",
      message: helper_plugin_esm/* translatedErrors.unique */.I0.unique,
      test(value) {
        if (!value) {
          return false;
        }
...
const createComponentSchema = (usedComponentNames, reservedNames, category) => {
  const shape = {
    ...
    category: yup_es/* string */.Z_().matches(regex, helper_plugin_esm/* translatedErrors.regex */.I0.regex).required(helper_plugin_esm/* translatedErrors.required */.I0.required),
...
const validators = {
  ...
  name(usedNames, reservedNames) {
    return yup_es/* string */.Z_().test(alreadyUsedAttributeNames(usedNames)).test(isNameAllowed(reservedNames)).matches(NAME_REGEX, helper_plugin_esm/* translatedErrors.regex */.I0.regex).required(helper_plugin_esm/* translatedErrors.required */.I0.required);
  },
  required: () => yup_es/* boolean */.O7(),
  type: () => yup_es/* string */.Z_().required(helper_plugin_esm/* translatedErrors.required */.I0.required),
...
const types = {
  ...
  biginteger(usedAttributeNames, reservedNames) {
    const shape = {
      ...
      unique: validators.unique(),
      required: validators.required(),
      max: yup_es/* string */.Z_().nullable().matches(/^-?\d*$/, helper_plugin_esm/* translatedErrors.regex */.I0.regex),
      min: yup_es/* string */.Z_().nullable().test(isMinSuperiorThanMax).matches(/^-?\d*$/, helper_plugin_esm/* translatedErrors.regex */.I0.regex)
    };
    return yup_es/* object */.Ry(shape);
  },
  ...
  component(usedAttributeNames, reservedNames) {
    const shape = {
      ...
      max: validators.max(),
      min: validators.min(),
      component: yup_es/* string */.Z_().required(helper_plugin_esm/* translatedErrors.required */.I0.required)
    };
    return yup_es/* object */.Ry(shape);
  },
  ...
  enumeration(usedAttributeNames, reservedNames) {
    ...
    const shape = {
      name: yup_es/* string */.Z_().test(alreadyUsedAttributeNames(usedAttributeNames)).test(isNameAllowed(reservedNames)).matches(GRAPHQL_ENUM_REGEX, helper_plugin_esm/* translatedErrors.regex */.I0.regex).required(helper_plugin_esm/* translatedErrors.required */.I0.required),
      type: validators.type(),
      default: validators["default"](),
      unique: validators.unique(),
      required: validators.required(),
      enum: yup_es/* array */.IX().of(yup_es/* string */.Z_()).min(1, helper_plugin_esm/* translatedErrors.min */.I0.min).test({
  ...
  relation(usedAttributeNames, reservedNames, alreadyTakenTargetAttributes, { initialData, modifiedData }) {
    const shape = {
      name: validators.name(usedAttributeNames, reservedNames),
      target: yup_es/* string */.Z_().required(helper_plugin_esm/* translatedErrors.required */.I0.required),
      ...
      targetAttribute: yup_es/* lazy */.Vo(() => {
        ...
        return schema.matches(NAME_REGEX, helper_plugin_esm/* translatedErrors.regex */.I0.regex).test({
...
const FormModal = () => {
  ...
  const customField = (0,helper_plugin_esm/* useCustomFields */.mZ)().get(customFieldUid);
  ...
  const { formatMessage } = (0,useIntl/* default */.Z)();
  const { getPlugin } = (0,helper_plugin_esm/* useStrapiApp */.j1)();
  ...
  return /* @__PURE__ */ react.createElement(ModalLayout/* ModalLayout */.P, { onClose: handleClosed, labelledBy: "title" }, /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 6 }, /* @__PURE__ */ react.createElement(TabPanels/* TabPanels */.n, null, /* @__PURE__ */ react.createElement(TabPanels/* TabPanel */.x, null, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { direction: "column", alignItems: "stretch", gap: 6 }, /* @__PURE__ */ react.createElement(
      components_TabForm,
      {
        form: baseForm,
        formErrors,
    ...
    ))), /* @__PURE__ */ react.createElement(TabPanels/* TabPanel */.x, null, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { direction: "column", alignItems: "stretch", gap: 6 }, /* @__PURE__ */ react.createElement(
      components_TabForm,
      {
        form: advancedForm,
        formErrors,
...
const DataManagerProvider = ({
  ...
  const dispatch = (0,es/* useDispatch */.I0)();
  const toggleNotification = (0,helper_plugin_esm/* useNotification */.lm)();
  const { lockAppWithAutoreload, unlockAppWithAutoreload } = (0,helper_plugin_esm/* useAutoReloadOverlayBlocker */.Vu)();
  const { setCurrentStep } = (0,helper_plugin_esm/* useGuidedTour */.c1)();
  const { getPlugin } = (0,helper_plugin_esm/* useStrapiApp */.j1)();
  const { apis } = getPlugin(pluginId/* default */.Z);
  const { autoReload } = (0,helper_plugin_esm/* useAppInfos */.QI)();
  const { formatMessage } = (0,useIntl/* default */.Z)();
  const { trackUsage } = (0,helper_plugin_esm/* useTracking */.rS)();
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    isLoadingForDataToBeSet ? /* @__PURE__ */ react.createElement(helper_plugin_esm/* LoadingIndicatorPage */.dO, null) : /* @__PURE__ */ react.createElement(react.Fragment, null, children, isInDevelopmentMode && /* @__PURE__ */ react.createElement(components_FormModal, null))
  );
};
...
const ListView = (0,react.lazy)(
  () => __webpack_require__.e(/* import() | content-type-builder-recursive-path */ 5905).then(__webpack_require__.bind(__webpack_require__, 76761))
);
const RecursivePath = () => {
  const { url } = (0,react_router/* useRouteMatch */.$B)();
  const { categoryUid } = (0,react_router/* useParams */.UO)();
  return /* @__PURE__ */ react.createElement(react.Suspense, { fallback: /* @__PURE__ */ react.createElement(helper_plugin_esm/* LoadingIndicatorPage */.dO, null) }, /* @__PURE__ */ react.createElement(react_router/* Switch */.rs, null, /* @__PURE__ */ react.createElement(react_router/* Route */.AW, { path: `${url}/:componentUid` }, /* @__PURE__ */ react.createElement(ListView, { categoryId: categoryUid }))));
};
...
`, x = styled_components_browser_esm/* default.button */.ZP.button`
  border: none;
  padding: 0;
  background: transparent;
  display: flex;
  align-items: center;
`, S = styled_components_browser_esm/* default.div */.ZP.div`
  display: flex;
  align-items: center;
  width: ${12 / 16}rem;
  transform: rotateX(${({ rotated: t }) => t ? "0deg" : "180deg"});
`, l = ({ label: t, children: p, id: s }) => {
  const [r, m] = (0,react.useState)(!0), d = (0,useId/* useId */.M)(s), c = () => {
    m((n) => !n);
  };
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, null, /* @__PURE__ */ react.createElement(k, { paddingLeft: 7, paddingTop: 2, paddingBottom: 2, paddingRight: 4 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "space-between" }, /* @__PURE__ */ react.createElement(x, { onClick: c, "aria-expanded": r, "aria-controls": d }, /* @__PURE__ */ react.createElement(S, { rotated: r }, /* @__PURE__ */ react.createElement(CarretDown/* default */.Z, { "aria-hidden": !0 })), /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingLeft: 2 }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { as: "span", fontWeight: "semiBold", textColor: "neutral800" }, t))))), r && /* @__PURE__ */ react.createElement("ul", { id: d }, react.Children.map(p, (n, u) => /* @__PURE__ */ react.createElement("li", { key: u }, n))));
};
l.defaultProps = {
  id: void 0
};
...
const useContentTypeBuilderMenu = () => {
  ...
  const matchByTitle = (links) => search ? (0,match_sorter_esm/* default */.Z)(links, toLower_default()(search), { keys: [(item) => toLower_default()(item.title)] }) : links;
  const getMenu = () => {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(SubNavSections/* SubNavSections */.Z, null, menu.map((section) => /* @__PURE__ */ react.createElement(react.Fragment, { key: section.name }, /* @__PURE__ */ react.createElement(
      ...
      TextButton/* TextButton */.A,
      {
        ...
        startIcon: /* @__PURE__ */ react.createElement(Icon/* Icon */.J, { as: Plus/* default */.Z, width: (0,helper_plugin_esm/* pxToRem */.Q1)(8), height: (0,helper_plugin_esm/* pxToRem */.Q1)(8) }),
        marginTop: 2
      },
      formatMessage({
...
const App_ListView = (0,react.lazy)(
  () => __webpack_require__.e(/* import() | content-type-builder-list-view */ 5905).then(__webpack_require__.bind(__webpack_require__, 76761))
);
const App = () => {
  const { formatMessage } = (0,useIntl/* default */.Z)();
  ...
  return /* @__PURE__ */ react.createElement(helper_plugin_esm/* CheckPagePermissions */.O4, { permissions: permissions/* default.main */.Z.main }, /* @__PURE__ */ react.createElement(Helmet/* Helmet */.q, { title }), /* @__PURE__ */ react.createElement(components_FormModalNavigationProvider, null, /* @__PURE__ */ react.createElement(components_DataManagerProvider, null, /* @__PURE__ */ react.createElement(Layout/* Layout */.A, { sideNav: /* @__PURE__ */ react.createElement(components_ContentTypeBuilderNav, null) }, /* @__PURE__ */ react.createElement(react.Suspense, { fallback: /* @__PURE__ */ react.createElement(helper_plugin_esm/* LoadingIndicatorPage */.dO, null) }, /* @__PURE__ */ react.createElement(react_router/* Switch */.rs, null, /* @__PURE__ */ react.createElement(
...
// EXTERNAL MODULE: ./node_modules/@strapi/design-system/dist/Select/Option.js
var Option = __webpack_require__(82562);
;// CONCATENATED MODULE: ./node_modules/@strapi/design-system/dist/Select/OptGroup.js



const OptGroup_o = ({ children: e, label: p, ...a }) => {
...
OptGroup_o.propTypes = {
  children: prop_types.arrayOf(prop_types.node).isRequired,
  label: prop_types.string.isRequired
};
OptGroup_o.displayName = "OptGroup";


// EXTERNAL MODULE: ./node_modules/@strapi/design-system/dist/Select/Select.js + 8 modules
var Select = __webpack_require__(48302);
;// CONCATENATED MODULE: ./node_modules/@strapi/design-system/dist/Select/MultiSelectNested.js





const c = ({ options: u, ...i }) => /* @__PURE__ */ react.createElement(Select/* Select */.P, { multi: !0, ...i }, u.map(
  ({ label: t, value: o, children: m }) => m ? /* @__PURE__ */ react.createElement(OptGroup_o, { key: t, label: t }, m?.map((r) => /* @__PURE__ */ react.createElement(Option/* Option */.W, { key: r.value, value: r.value }, r.label))) : /* @__PURE__ */ react.createElement(Option/* Option */.W, { key: o, value: o }, t)
));
c.propTypes = {
  options: prop_types.arrayOf(prop_types.object).isRequired
};
