"use strict";
(self["webpackChunklms"] = self["webpackChunklms"] || []).push([[801],{
...
const package_namespaceObject = {"i8":"4.9.1"};
...
const LeftMenu = ({ generalSectionLinks, pluginsSectionLinks }) => {
  ...
  const { userDisplayName } = (0,helper_plugin_esm/* useAppInfos */.QI)();
  const { formatMessage } = (0,useIntl/* default */.Z)();
  const { trackUsage } = (0,helper_plugin_esm/* useTracking */.rS)();
...
const Onboarding = () => {
  ...
  const { formatMessage } = (0,useIntl/* default */.Z)();
  const { communityEdition } = (0,helper_plugin_esm/* useAppInfos */.QI)();
  ...
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, { as: "aside", position: "fixed", bottom: 2, right: 2 }, /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(FocusTrap/* FocusTrap */.i, { onEscape: handlePopoverVisibility }, /* @__PURE__ */ react.createElement(
      Flex/* Flex */.k,
      {
    ...
    ), /* @__PURE__ */ react.createElement(Divider/* Divider */.i, null), VIDEO_LINKS.map(({ href, duration, label }, index) => /* @__PURE__ */ react.createElement(
      VideoLinkWrapper,
      {
        as: "a",
        href,
...
const CM = (0,react.lazy)(
  () => Promise.all(/* import() | content-manager */[__webpack_require__.e(233), __webpack_require__.e(3848), __webpack_require__.e(6798), __webpack_require__.e(994)]).then(__webpack_require__.bind(__webpack_require__, 79932))
);
...
const MarketplacePage = (0,react.lazy)(
  () => Promise.all(/* import() | Admin_marketplace */[__webpack_require__.e(233), __webpack_require__.e(5516)]).then(__webpack_require__.bind(__webpack_require__, 82679))
);
...
const fetchStrapiLatestRelease = async (toggleNotification) => {
  try {
    const {
      data: { tag_name }
    } = await axios["default"].get("https://api.github.com/repos/strapi/strapi/releases/latest");
...
const AuthenticatedApp = () => {
  ...
  return /* @__PURE__ */ react.createElement(helper_plugin_esm/* AppInfosContext.Provider */.NY.Provider, { value: appInfosValue }, /* @__PURE__ */ react.createElement(components_RBACProvider, { permissions, refetchPermissions: refetch }, /* @__PURE__ */ react.createElement(components_PluginsInitializer, null)));
};
