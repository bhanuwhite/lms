"use strict";
(self["webpackChunklms"] = self["webpackChunklms"] || []).push([[4263],{
...
/* harmony import */ var _strapi_design_system__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(48302);
...
const SelectRoles = ({ disabled, error, onChange, value }) => {
  ...
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
    ...
    (data || []).map((role) => {
      return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_7__/* .Option */ .W, { key: role.id, value: role.id }, formatMessage({
        id: `global.${role.code}`,
