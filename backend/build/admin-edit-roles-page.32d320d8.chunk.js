(self["webpackChunklms"] = self["webpackChunklms"] || []).push([[2544],{
...
const CreatePage = () => {
  ...
  const handleCreateRoleSubmit = (data) => {
    ...
    Promise.resolve(
      (0,helper_plugin_esm/* request */.WY)("/admin/roles", {
        method: "POST",
        body: data
      })
    ).then(async (res) => {
      ...
      if (res.data.id && !isEmpty_default()(permissionsToSend)) {
        await (0,helper_plugin_esm/* request */.WY)(`/admin/roles/${res.data.id}/permissions`, {
          method: "PUT",
...
const EditPage = () => {
  ...
  const handleEditRoleSubmit = async (data) => {
    try {
      ...
      await (0,helper_plugin_esm/* request */.WY)(`/admin/roles/${id}`, {
        method: "PUT",
        body: data
      });
      if (role.code !== "strapi-super-admin") {
        await (0,helper_plugin_esm/* request */.WY)(`/admin/roles/${id}/permissions`, {
          method: "PUT",
          body: {
