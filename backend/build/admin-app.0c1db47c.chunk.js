...
const Register = ({ authType, fieldsToDisable, noSignin, onSubmit, schema }) => {
  ...
  return /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* default */.ZP, null, /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* LayoutContent */.bU, null, /* @__PURE__ */ react.createElement(
    ...
    ({ values, errors, handleChange }) => {
      return /* @__PURE__ */ react.createElement(helper_plugin_esm/* Form */.l0, { noValidate: true }, /* @__PURE__ */ react.createElement(Main/* Main */.o, null, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { direction: "column", alignItems: "stretch", gap: 3 }, /* @__PURE__ */ react.createElement(UnauthenticatedLogo/* default */.Z, null), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { as: "h1", variant: "alpha", textAlign: "center" }, formatMessage({
...
const UseCasePage = () => {
  ...
  return /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* default */.ZP, null, /* @__PURE__ */ react.createElement(Main/* Main */.o, { labelledBy: "usecase-title" }, /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* LayoutContent */.bU, null, /* @__PURE__ */ react.createElement("form", { onSubmit: () => handleSubmit(false) }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { direction: "column", paddingBottom: 7 }, /* @__PURE__ */ react.createElement(UnauthenticatedLogo/* default */.Z, null), /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 6, paddingBottom: 1, width: (0,helper_plugin_esm/* pxToRem */.Q1)(250) }, /* @__PURE__ */ react.createElement(TypographyCenter, { variant: "alpha", as: "h1", id: "usecase-title" }, formatMessage({
    id: "Usecase.title",
...
// EXTERNAL MODULE: ./node_modules/@fingerprintjs/fingerprintjs/dist/fp.esm.js + 1 modules
var fp_esm = __webpack_require__(62196);
...
function App() {
  ...
  const appInfo = (0,helper_plugin_esm/* useAppInfos */.QI)();
  ...
  (0,react.useEffect)(() => {
    ...
    const renewToken = async () => {
      try {
        const {
          data: { token }
        } = await (0,helper_plugin_esm/* request */.WY)("/admin/renew-token", {
          method: "POST",
  ...
  (0,react.useEffect)(() => {
    const getData = async () => {
      try {
        ...
        } = await axios["default"].get(`${strapi.backendURL}/admin/init`);
...
const LanguageProvider = ({ children, localeNames, messages }) => {
  ...
  return /* @__PURE__ */ react.createElement(provider/* default */.Z, { locale, defaultLocale: "en", messages: appMessages, textComponent: "span" }, /* @__PURE__ */ react.createElement(components_LocalesProvider, { changeLocale, localeNames, messages: appMessages }, children));
};
...
const Overlay = (0,styled_components_browser_esm/* default */.ZP)(Box/* Box */.x)`
  position: fixed;
  top: 0;
  right: 0;
  bottom: 0;
...
`;
const Content = (0,styled_components_browser_esm/* default */.ZP)(Flex/* Flex */.k)`
  position: fixed;
  top: 0;
  right: 0;
  bottom: 0;
  left: 0;
  padding-top: ${(0,helper_plugin_esm/* pxToRem */.Q1)(160)};
`;
...
`;
const LoaderReload = (0,styled_components_browser_esm/* default */.ZP)(Refresh/* default */.Z)`
...
const Blocker = ({ displayedIcon, description, title, isOpen }) => {
  ...
  if (isOpen) {
    return react_dom.createPortal(
      /* @__PURE__ */ react.createElement(Overlay, null, /* @__PURE__ */ react.createElement(Content, { direction: "column", alignItems: "stretch", gap: 6 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { direction: "column", alignItems: "stretch", gap: 2 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "center" }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { as: "h1", variant: "alpha" }, formatMessage(title))), /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "center" }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { as: "h2", textColor: "neutral600", fontSize: 4, fontWeight: "regular" }, formatMessage(description)))), /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "center" }, displayedIcon === "reload" && /* @__PURE__ */ react.createElement(IconBox, { padding: 6, background: "primary100", borderColor: "primary200" }, /* @__PURE__ */ react.createElement(LoaderReload, { width: (0,helper_plugin_esm/* pxToRem */.Q1)(36), height: (0,helper_plugin_esm/* pxToRem */.Q1)(36) })), displayedIcon === "time" && /* @__PURE__ */ react.createElement(IconBox, { padding: 6, background: "primary100", borderColor: "primary200" }, /* @__PURE__ */ react.createElement(Clock/* default */.Z, { width: (0,helper_plugin_esm/* pxToRem */.Q1)(40), height: (0,helper_plugin_esm/* pxToRem */.Q1)(40) }))), /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "center" }, /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 2 }, /* @__PURE__ */ react.createElement(Link/* Link */.r, { href: "https://docs.strapi.io", isExternal: true }, formatMessage({
...
const AutoReloadOverlayBlockerProvider = ({ children }) => {
  ...
  return /* @__PURE__ */ react.createElement(helper_plugin_esm/* AutoReloadOverlayBockerContext.Provider */.Uu.Provider, { value: autoReloadValue }, /* @__PURE__ */ react.createElement(
...
const Notification = ({ dispatch, notification }) => {
  ...
  if (title) {
    alertTitle = typeof title === "string" ? title : formattedMessage({
      id: title?.id || title,
...
const Notifications = ({ children }) => {
  ...
  return /* @__PURE__ */ react.createElement(helper_plugin_esm/* NotificationsProvider */.N$, { toggleNotification: displayNotification }, /* @__PURE__ */ react.createElement(
    Flex/* Flex */.k,
    {
      left: "50%",
      marginLeft: "-250px",
...
const OverlayBlocker_Overlay = styled_components_browser_esm/* default.div */.ZP.div`
  position: fixed;
  top: 0;
  right: 0;
  bottom: 0;
...
const OverlayBlockerProvider = ({ children }) => {
  ...
  return /* @__PURE__ */ react.createElement(helper_plugin_esm/* OverlayBlockerContext.Provider */.vG.Provider, { value: { lockApp, unlockApp } }, children, /* @__PURE__ */ react.createElement(Portal, { isOpen }));
};
    ...
    try {
      const [{ data: components }, { data: contentTypes }] = await Promise.all(
        ["components", "content-types"].map(
          (endPoint) => (0,helper_plugin_esm/* request */.WY)(`/content-manager/${endPoint}`, { method: "GET" })
        )
      );
      dispatch({
...
const useFetchPermissionsLayout = (id) => {
  ...
  (0,react.useEffect)(() => {
    const getData = async () => {
      ...
      const { data: data2 } = await (0,helper_plugin_esm/* request */.WY)("/admin/permissions", {
        method: "GET",
        params: { role: id }
      });
      dispatch({
    ...
    try {
      const [{ data: role }, { data: permissions }] = await Promise.all(
        [`roles/${roleId}`, `roles/${roleId}/permissions`].map(
          (endPoint) => (0,helper_plugin_esm/* request */.WY)(`/admin/${endPoint}`, { method: "GET" })
        )
      );
      dispatch({
        type: "GET_DATA_SUCCEEDED",
...
const useMenu = () => {
  ...
  const { shouldUpdateStrapi } = (0,helper_plugin_esm/* useAppInfos */.QI)();
...
const useSettingsForm = (endPoint, schema, cbSuccess, fieldsToPick) => {
  ...
  (0,react.useEffect)(() => {
    const getData = async () => {
      try {
        const { data } = await (0,helper_plugin_esm/* request */.WY)(endPoint, { method: "GET" });
        dispatch({
          type: "GET_DATA_SUCCEEDED",
          data,
          fieldsToPick
  ...
  const handleSubmit = async (e) => {
    ...
    if (!errors) {
      try {
        ...
        const { data } = await (0,helper_plugin_esm/* request */.WY)(endPoint, {
          method: "PUT",
          body: cleanedData
        });
        cbSuccess(data);
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(67294);
/* harmony import */ var _strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(86597);
...
/* harmony import */ var formik__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(94649);
...
const useAuthProviders = ({ ssoEnabled }) => {
  ...
  const fetchAuthProviders = async () => {
    try {
      ...
      const data = await (0,helper_plugin_esm/* request */.WY)(requestUrl, { method: "GET" });
      dispatch({
        type: "GET_DATA_SUCCEEDED",
        data
      });
...
/* harmony import */ var react_router__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(16550);
/* harmony import */ var _strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(86597);
...
const useLicenseLimitNotification = () => {
  ...
  const { pathname } = (0,react_router__WEBPACK_IMPORTED_MODULE_5__/* .useLocation */ .TH)();
...
/* harmony export */   "Z": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(86597);
...
const SSOProviderButton = ({ provider }) => {
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_3__/* .Tooltip */ .u, { label: provider.displayName }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(SSOButton, { href: `${strapi.backendURL}/admin/connect/${provider.uid}` }, provider.icon ? /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement("img", { src: provider.icon, "aria-hidden": true, alt: "", height: "32px" }) : /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_4__/* .Typography */ .Z, null, provider.displayName)));
};
