"use strict";
(self["webpackChunklms"] = self["webpackChunklms"] || []).push([[5516],{
...
const i = styled_components_browser_esm/* default.div */.ZP.div`
  display: grid;
...
const o = (e) => /* @__PURE__ */ (0,jsx_runtime.jsx)("svg", {
  width: "1rem",
  height: "1rem",
  viewBox: "0 0 24 25",
  fill: "none",
...
const fetchMarketplaceProviders = async (params = {}) => {
  const { data } = await axios["default"].get(`${MARKETPLACE_API_URL}/providers`, {
    params
  });
  return data;
};
...
const fetchMarketplacePlugins = async (params = {}) => {
  const { data: response } = await axios["default"].get(`${api_MARKETPLACE_API_URL}/plugins`, {
    params
  });
...
const a = (l) => /* @__PURE__ */ (0,jsx_runtime.jsxs)("svg", {
  width: "1rem",
  height: "1rem",
  viewBox: "0 0 32 32",
  fill: "none",
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(
      helper_plugin_esm/* ContentBox */.Y_,
      {
        ...
        icon: /* @__PURE__ */ react.createElement(GlassesSquare_i, null),
...
const r = (l) => /* @__PURE__ */ (0,jsx_runtime.jsx)("svg", {
  width: "1rem",
  height: "1rem",
  viewBox: "0 0 24 24",
  fill: "none",
...
const FiltersPopover = ({
  ...
  const { formatMessage } = (0,useIntl/* default */.Z)();
  return /* @__PURE__ */ react.createElement(Popover/* Popover */.J2, { source, padding: 3, spacing: 4, onBlur: () => {
  } }, /* @__PURE__ */ react.createElement(FocusTrap/* FocusTrap */.i, { onEscape: onToggle }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { direction: "column", alignItems: "stretch", gap: 1 }, /* @__PURE__ */ react.createElement(Box/* Box */.x, null, /* @__PURE__ */ react.createElement(
...
const matchSearch = (npmPackages, search) => {
  return (0,match_sorter_esm/* default */.Z)(npmPackages, search, {
    keys: [
      {
        threshold: match_sorter_esm/* default.rankings.WORD_STARTS_WITH */.Z.rankings.WORD_STARTS_WITH,
        key: "attributes.name"
      },
      { threshold: match_sorter_esm/* default.rankings.WORD_STARTS_WITH */.Z.rankings.WORD_STARTS_WITH, key: "attributes.description" }
    ],
...
const MarketPlacePage = () => {
  ...
  const { autoReload: isInDevelopmentMode, dependencies, useYarn, strapiVersion } = (0,helper_plugin_esm/* useAppInfos */.QI)();
...
const e = (i) => /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("svg", {
  width: "1rem",
  height: "1rem",
  viewBox: "0 0 24 24",
  fill: "none",
