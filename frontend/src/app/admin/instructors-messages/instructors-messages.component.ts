...
import { Messages, msgCategories } from 'src/app/models/messages';
...
@Component({
  selector: 'app-instructors-messages',
  templateUrl: './instructors-messages.component.html',
  styleUrls: ['./instructors-messages.component.scss']
})
export class InstructorsMessagesComponent {
  ...
  constructor(private messageChatService: MessageChatService){
  ...
  public multiSelectAndCheckBoxes():void{
   ...
   public getAllMessages():void{
      try{
        this.messageChatService.getMessagesCategories().subscribe((data)=>{
